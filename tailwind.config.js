...
module.exports = {
  ...
  theme: {
    backgroundImage: {
      ...
      'home-header-bg-7': "url('/images/new/home/home-header-6.png')",
      ...
      'sangju-header-bg': "url('/images/new/interview/clientbgimage/SangjuBgImage.png')",
      'kepri-header-bg': "url('/images/new/interview/clientbgimage/KepriBgImage.png')",
      'dapa-header-bg': "url('/images/new/interview/clientbgimage/DapaBgImage.png')",
      'comwel-header-bg': "url('/images/new/interview/clientbgimage/ComwelBgImage.png')",
      'army-header-bg': "url('/images/new/interview/clientbgimage/ArmyBgImage.png')",
      'gyeongnam-header-bg': "url('/images/new/interview/clientbgimage/GyeongnamBgImage.png')",
      'coocon-header-bg': "url('/images/new/interview/clientbgimage/CooconBgImage.png')",
      'yit-header-bg': "url('/images/new/interview/clientbgimage/YitBgImage.png')",
      'usc-header-bg': "url('/images/new/interview/clientbgimage/UscBgImage.png')",
      't3q-header-bg': "url('/images/new/interview/clientbgimage/T3qBgImage.png')",
      'hc-header-bg': "url('/images/new/interview/clientbgimage/HcBgImage.png')",
      'ekr-header-bg': "url('/images/new/interview/clientbgimage/EkrBgImage.png')",
      'kipo-header-bg': "url('/images/new/interview/clientbgimage/KipoBgImage.png')",
      'gb-header-bg': "url('/images/new/interview/clientbgimage/GbBgImage.png')",
      'ycg-header-bg': "url('/images/new/interview/clientbgimage/YcgBgImage.png')",
      'goryeong-header-bg': "url('/images/new/interview/clientbgimage/GoryeongBgImage.png')",
